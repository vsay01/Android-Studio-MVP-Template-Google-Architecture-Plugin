...
fun RecipeExecutor.mviSetup(
	...
	val activityClass = "${className}Activity"
	val fragmentClass = "${className}Fragment"
	val contractClass = "${className}Contract"
	val presenterClass = "${className}Presenter"
	val activityTitle = "$className Activity"
